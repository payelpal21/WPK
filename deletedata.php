...
<address>
 ...
 <h3> Women's Polytechnic Kolkata ( <?php echo Date('D-M-Y');  ;?> )</h3>        
        ...
        <br><br>
  <div class="container">
  <form action="deletedata.php" method="post" autocomplete="off">
     ...
     <label for="sl"> Do you want to delete the data ?<br> Enter the Serial No.</label> <span style="color:red">*</span>
...
if(isset($_POST['register']))
{
   ...
   $query = " DELETE FROM `studentregistration` WHERE `class_serial`='$Se' ";
