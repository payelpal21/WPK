...
<address>
 ...
 <h1> Student Library Status</h1>
 
        <div class="search">
<form action="libstatus.php" method="post">
...
<input type="submit" name="shrestha" value="search">    
         </form>
...
<script>
   ...
   window.alert('No data found');
    window.open('applyLibrarycard.php', '_self');
