...
<address>
 ...
 <h3> Women's Polytechnic Kolkata ( <?php echo Date('D-M-Y');  ;?> )</h3>        
        ...
        <h4> Student Approval  Form</h4>
        
        
        <br><br>
  <div class="container">
  <form action="approvedata.php" method="post" autocomplete="off">
     ...
     <label for="sl"> Do you want to Approve  the data ?<br> Enter the Serial No.</label> <span style="color:red">*</span>
...
if(isset($_POST['register']))
{
   ...
   $query = " UPDATE `studentregistration` SET `class_serial`='$Se',`status`='$Approve' WHERE `class_serial`='$Se' ";
