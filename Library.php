...
<address>
 ...
 <h1> Student Library Records</h1>
 
        <div class="search">
<form action="Librarysearch.php" method="post" target="_blank">
        
    
<input type="submit" name="shrestha" value="Search Students Record">    
         </form>
...
$query = "SELECT * FROM `applynewcard`";
